...
import { FaDownload, FaQuoteLeft, FaTimes } from 'react-icons/fa';

const TabButton = ({ active, children, onClick }) => (
  <motion.button
    className={`px-6 py-3 rounded-full text-lg font-semibold transition-all duration-300 ${active ? 'bg-indigo-600 text-white shadow-lg' : 'bg-gray-200 text-gray-800 hover:bg-gray-300'}`}
...
const AboutSection = () => {
  ...
  const tabs = ['bio', 'experience', 'testimonials'];
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeTab === 'bio' && (
                  <div>
                    <h3 className="text-3xl font-semibold text-indigo-600 mb-6">Hello, I'm Your Name</h3>
